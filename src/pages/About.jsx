    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      >
        ...
        <div className="relative bg-black p-8 rounded-xl border border-blue-light/20">
          <div className="flex items-center gap-6">
            <div className="w-32 h-32 overflow-hidden flex items-start justify-center flex-shrink-0">
              <img src="GDSC.png" alt="GDG Club" className="object-cover h-10" />
            </div>

            <div className="flex-grow">
              <Link
  to="https://dscdypcoe.web.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block px-4 py-2 rounded-full bg-purple-200/5 hover:bg-yellow-500 
                   border border-yellow-500 text-white transition-all duration-300 font-['Arial'] text-sm mb-3 font-extrabold"
      ...
      >
        ...
        <div className="relative bg-black p-8 rounded-xl border border-blue-light/20">
          <div className="flex items-center gap-6">
          <div className="w-32 h-32  overflow-hidden  flex items-start justify-center flex-shrink-0">
                    <img src="IASC.png" alt="IASC Club" className="object-cover " />
                  </div>

            <div className="flex-grow">
              <Link
                  to="https://iasc-web2.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block px-4 py-2 rounded-full bg-purple-200/5 hover:bg-yellow-500 
                   border border-yellow-500 text-white transition-all duration-300 font-['Arial'] text-sm mb-3 font-extrabold"
