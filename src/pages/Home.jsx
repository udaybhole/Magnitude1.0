    ...
    >
            <h1 className="flex flex-col items-center gap-4 sm:gap-6">
              <div className="relative perspective-[1000px]">
                <span className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-['SpaceMission'] tracking-[0.2em] text-purple-400">
                  DYPCOE
                </span>
                ...
                >
                  {magnitudeText.split("").map((letter, index) => (
                    <motion.span
                      ...
                      className="bg-gradient-to-r from-purple-700 via-blue-bright to-blue-pale bg-clip-text text-transparent inline-block transform-gpu"
                      style={{
                ...
                <span className="text-3xl xs:text-4xl md:text-5xl font-['SpaceMission'] tracking-[0.2em] text-purple-400">
                  2K
                  <motion.span
                    animate={controls}
          ...
          >
            ...
            <div className="relative bg-black p-8 rounded-xl border border-blue-light/20">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-3xl md:text-4xl text-blue-light mb-2 tracking-wider font-bold font-['SpaceMission']">
                    UPDATES
                  </h2>
                ...
                <motion.button
                  ...
                  className="px-6 py-2 bg-blue-light/10 hover:bg-blue-light/20 rounded-full 
                    border border-blue-light/30 text-blue-pale transition-all duration-300 font-['Arial'] font-bold"
                >
                  Check Updates
                </motion.button>
              </div>
        ...
        <div className="max-w-5xl mx-auto py-20 px-4">
          <div className="relative">
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-['SpaceMission'] font-bold text-center mb-16 bg-gradient-to-r from-blue-light via-blue-bright to-blue-pale bg-clip-text text-transparent"
            >
              EVENT TIMELINE
            </motion.h2>
            ...
            <div className="space-y-16">
              ...
              >
                <div className="flex-1 md:text-right md:pr-8 font-['Arial'] font-bold">
                  <div className="relative p-6 bg-black/30 backdrop-blur-sm rounded-xl border border-blue-light/20 transition-all duration-300 hover:border-blue-light/50 group-hover:shadow-[0_0_15px_rgba(147,197,253,0.15)] md:ml-auto md:w-[380px]">
                    <div className="flex items-center md:justify-end gap-3 mb-4">
                      <h3 className="text-3xl text-blue-light tracking-wider font-['Arial'] font-bold">
                        PHASE 01
                      </h3>
                      <BsCalendar2Check className="text-2xl text-blue-pale" />
                    </div>
                    <h4 className="text-xl font-['Arial'] text-blue-pale mb-2">
                    ...
                    <ul className="text-sm text-gray-400 space-y-1">
                      <li className="flex items-center md:justify-end gap-2 font-['Arial']">
...
>
  <div className="flex-1 md:text-left md:pl-8 font-['Arial'] font-bold">
    <div className="relative p-6 bg-black/30 backdrop-blur-sm rounded-xl border border-blue-light/20 transition-all duration-300 hover:border-blue-light/50 group-hover:shadow-[0_0_15px_rgba(147,197,253,0.15)] md:mr-auto md:w-[380px]">
  ...
  <div className="flex-1 md:pr-8 md:invisible" />
              ...
              >
                <div className="flex-1 md:text-right md:pr-8">
                  <div className="relative p-6 bg-black/30 backdrop-blur-sm rounded-xl border border-blue-light/20 transition-all duration-300 hover:border-blue-light/50 group-hover:shadow-[0_0_15px_rgba(147,197,253,0.15)] md:ml-auto md:w-[380px]">
                    <div className="flex items-center md:justify-end gap-3 mb-4">
                      <h3 className="text-3xl text-blue-light tracking-wider font-bold font-['Arial']">
                        FINAL PHASE
                      </h3>
                      <BsTrophy className="text-2xl text-blue-pale" />
                    </div>
                    <h4 className="text-xl text-blue-pale mb-2 font-['Arial'] font-bold">
                      Grand Finale
                    </h4>
                    <p className="text-gray-400 mb-3 font-['Arial']">
                      15th March 2024
...
<div className="relative z-10 max-w-4xl mx-auto py-20 px-4 text-center">
          ...
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-3xl md:text-4xl font-['SpaceMission'] mb-4 text-blue-light"
          >
            WIN PRIZE POOL OF
          </motion.h2>
      ...
      <div className="max-w-4xl mx-auto py-20 px-4 text-center">
        ...
        >
          ...
          <h3 className="text-[40px] font-['SpaceMission'] text-blue-light tracking-wider">
            VENUE
          </h3>
          ...
          <motion.div
            ...
            className="text-gray-400 space-y-2 font-bold font-['Arial']"
          >
